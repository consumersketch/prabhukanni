...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'acme_test' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\Bundle\TestBundle\Manager A Acme\Bundle\TestBundle\Manager instance.
     */
    protected function getAcmeTestService()
    {
        return $this->services['acme_test'] = new \Acme\Bundle\TestBundle\Manager('plain_value');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'test_db', 'user' => 'root', 'password' => 'cs123456', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Acme/Bundle/TestBundle/Entity'))), 'Acme\\Bundle\\TestBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AcmeTestBundle' => 'Acme\\Bundle\\TestBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ae130778d2d377859e9f2080895b444ac647f718fe64d6e2a7fc397f9d150dcb');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Acme/Bundle/TestBundle/Resources/views'), 'AcmeTest');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b4a9d9934c5e036e6cc210057342f9d7f');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'cs123456',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'b4a9d9934c5e036e6cc210057342f9d7f',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'b4a9d9934c5e036e6cc210057342f9d7f',
